"""DiffusionSampler: pure sampling logic without Lightning dependency.

This module provides :class:`DiffusionSampler`, a plain Python class that
...
for :class:`~agedi.diffusion.Diffusion` (the Lightning training wrapper).
"""
...
class DiffusionSampler:
    ...
    When used through :class:`~agedi.diffusion.Diffusion` (which inherits
    ...
    def device(self) -> torch.device:
        ...
        When used through :class:`~agedi.diffusion.Diffusion` (which also
