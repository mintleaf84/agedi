...
This module contains :class:`Diffusion`, a :class:`~lightning.LightningModule`
that wraps :class:`~agedi.diffusion.sampler.DiffusionSampler` and adds
PyTorch-Lightning training/validation hooks, loss computation, and
checkpoint serialisation via :meth:`~Diffusion.get_hparams`.
...
class Diffusion(LightningModule, DiffusionSampler):
    """Full diffusion model: training + sampling.

    Combines the :class:`~agedi.diffusion.sampler.DiffusionSampler` sampling
    ...
    def __init__(
        ...
        DiffusionSampler.__init__(self, score_model, noisers, regressor_model, eps)
